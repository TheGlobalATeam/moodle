...
Y.namespace('M.atto_link').Button = Y.Base.create('button', Y.M.editor_atto.EditorPlugin, [], {
    ...
    _filepickerCallback: function(params) {
        ...
        if (params.url !== '') {
            // Add the link.
            this._setLinkOnSelection(params.url, params.url);
    ...
    _setLink: function(e) {
        ...
        if (value !== '') {
            ...
            var url = value.trim();
            var name = url;
            var prefix_regex = new RegExp(/^[a-zA-Z]*\.*\/|^#|^[a-zA-Z]*:/);
            ...
            // Add the link.
            this._setLinkOnSelection(url, name);
     ...
     */
    _setLinkOnSelection: function(url, name) {
